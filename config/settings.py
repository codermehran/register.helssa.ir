...
ANALYTICS_SHOW_RAW_IP_TO_SUPERUSER = _env_bool("ANALYTICS_SHOW_RAW_IP_TO_SUPERUSER", False)
ANALYTICS_MASK_IPV4_LAST_OCTET = True
ANALYTICS_MASK_IPV6 = True
ANALYTICS_TRACKED_GET_PATHS = tuple(_env_list("ANALYTICS_TRACKED_GET_PATHS", ["/", "/register/"]))
